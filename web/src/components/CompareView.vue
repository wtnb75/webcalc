...
<template>
  <div class="flex h-full flex-col">
    <div ref="panesRef" class="flex min-h-0 flex-1">
      <div :style="{ flex: growths[0] }" class="min-w-0">
      ...
      />
      <div :style="{ flex: growths[1] }" class="min-w-0">
      ...
      />
      <div :style="{ flex: growths[2] }" class="min-w-0">
        <TerminalPane
          name="apcalc"
          :visible="visible"
